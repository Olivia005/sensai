...
const EntryForm = ({ type, entries, onChange }) => {
  ...
  useEffect(() => {
    if (improveContent && !isImproving) {
      //improvedcontent is the data we getting after improving with ai
  ...
  const handleImproveDescription = async () => {
    ...
    if (!description) {
      toast.error('Please enter a description to first.')
      return
    }
        ...
        <Card className='bg-dark'>
          ...
          <CardContent className='space-y-4'>
            ...
            <Button
              type='button'
              variant='ghost'
              className='bg-muted-foreground/10 border-2 border-muted-foreground/20 '
